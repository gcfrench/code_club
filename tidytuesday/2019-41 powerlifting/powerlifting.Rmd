...
Firstly download and format the powerlifting data. This gave me the opportunity to use the recent pivot_longer and pivot_wider functions in tidyr to gather and spread the data frame.
